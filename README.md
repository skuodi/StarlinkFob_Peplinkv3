...
## Contents
- [StarlinkFob\_Peplink\_v3](#starlinkfob_peplink_v3)
  - [Contents](#contents)
  - [Misc](#misc)
    - [1. Comments](#1-comments)
    - [2. Debug logs](#2-debug-logs)
    - [3. Logic flow](#3-logic-flow)
    - [4. Guide to adding new menus](#4-guide-to-adding-new-menus)
    - [5. Primary and secondary Wi-Fi](#5-primary-and-secondary-wi-fi)
  - [Core features](#core-features)
    - [1. Use asynchronous delays](#1-use-asynchronous-delays)
    - [2. Dual-core configuration](#2-dual-core-configuration)
    ...
    - [6. Home page rendering issue](#6-home-page-rendering-issue)
    - [7. HTTP server early startup](#7-http-server-early-startup)
    - [8. Startup sequence](#8-startup-sequence)
    - [9. New splash screen sequence](#9-new-splash-screen-sequence)
    - [10. Update time screen](#10-update-time-screen)
    - [11. Add sensors screen](#11-add-sensors-screen)
    ...
    - [14. Temperature alarm \& logging](#14-temperature-alarm--logging)
    - [15. Ping screen loop over hosts](#15-ping-screen-loop-over-hosts)
  - [Network](#network)
